...
for root, dirnames, filenames in os.walk(TRAIN_DIR):
    for filename in fnmatch.filter(filenames, "*.jpg"):
        ...
        with open('/home/ubuntu/volume/SiW_release/train_list.txt', 'a') as fw:
            fw.write(path + ' ' + path + ' ' + path + ' ')
        # print(path)
...
for root, dirnames, filenames in os.walk(TEST_DIR):
    for filename in fnmatch.filter(filenames, "*.jpg"):
        path = os.path.join(root, filename)
        if count % 10 == 0:
            with open('/home/ubuntu/volume/SiW_release/val_list.txt', 'a') as fw:
                fw.write(path + ' ' + path + ' ' + path + ' ')
            ...
            with open('/home/ubuntu/volume/SiW_release/test_list.txt', 'a') as fw:
                fw.write(path + ' ' + path + ' ' + path + ' ')
