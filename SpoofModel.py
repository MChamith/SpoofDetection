...
def cnn_model():
    ...
    X1 = Convolution2D(filters=64, kernel_size=(7, 7), padding='same', activation='relu')(input_img1)
    ...
    X2 = Convolution2D(filters=64, kernel_size=(7, 7), padding='same', activation='relu')(input_img2)
    ...
    X3 = Convolution2D(filters=64, kernel_size=(7, 7), padding='same', activation='relu')(input_img3)
    X3 = MaxPool2D(pool_size=(2, 2), strides=(2, 2))(X3)
    X3 = Convolution2D(filters=128, kernel_size=(7, 7), padding='same', activation='relu')(X3)
    X3 = MaxPool2D(pool_size=(2, 2), strides=(2, 2))(X3)
    X3 = Convolution2D(filters=256, kernel_size=(7, 7), padding='same', activation='relu')(X3)
    X3 = MaxPool2D(pool_size=(2, 2), strides=(2, 2))(X3)
    ...
    X = Convolution2D(filters=1024, kernel_size=(7, 7), padding='same', activation='relu')(X)
